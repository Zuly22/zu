 ...
 * @author jprod
 */
public class FrmCustomerSearch extends javax.swing.JDialog {
    List<Customer> ents;
    private View observer;
    private DefaultTableModel tableModel;
    TableRowSorter<TableModel> sorter; 

    public void setEnts(List<Customer> ents) {
        this.ents = ents;
        ...
        ents.forEach(customer -> tableModel.addRow(
                new Object[]{
                    customer.getId(),
                    customer.getName(),
                    UtilDate.toString(customer.getBirthDate()),
                    customer.getAge(),
                    customer.getPhone(),
                    customer.getEmail()
                }
     ...
     */
    public FrmCustomerSearch(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        tblCustomers.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cedula", "Nombre", "Fecha de Nacimiento", "Edad", "Telefono", "Correo"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmCustomerSearch.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmCustomerSearch dialog = new FrmCustomerSearch(new javax.swing.JFrame(), true);
